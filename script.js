            ...
            try {
                ...
                if (contentType && contentType.includes("image/")) {
                    ...
                    try {
                        ...
                        if (data.error) {
                            showErrorMessage(i, data.error);
                        } else if (data.image) {
                            updateImageCard(i, data.image);
                        } else {
                            showErrorMessage(i, "Invalid response format from API");
                        }
                    } catch (e) {
                        showErrorMessage(i, "Failed to parse API response");
                    }
                }
            } catch (error) {
                console.error("Generation error:", error);
                showErrorMessage(i, error.message || "An unexpected error occurred");
            }
        });
